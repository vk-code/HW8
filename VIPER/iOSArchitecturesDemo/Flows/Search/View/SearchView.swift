...
final class SearchView: UIView {
    ...
    let segmentControlView: UISegmentedControl = {
        let segment = UISegmentedControl(items: ["Apps", "Music"])
    ...
    private func addSegmentControl() {
        self.segmentControlView.translatesAutoresizingMaskIntoConstraints = false
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            self.segmentControlView.topAnchor.constraint(equalTo: self.topAnchor, constant: 8.0),
            self.segmentControlView.leadingAnchor.constraint(equalTo: safeArea.leadingAnchor),
            self.segmentControlView.trailingAnchor.constraint(equalTo: safeArea.trailingAnchor),
            
            self.searchBar.topAnchor.constraint(equalTo: self.segmentControlView.bottomAnchor, constant: 8.0),
